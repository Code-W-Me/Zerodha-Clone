import { a as __toESM, i as __toCommonJS, n as __esmMin, r as __exportAll, t as __commonJSMin } from "./chunk-MlKJSoC1.js";
import { t as require_react } from "./react.js";
import { t as require_jsx_runtime } from "./jsx-runtime-S0qp4x48.js";
...
function createBreakpoints(breakpoints) {
	const { values = {
		...
		lg: 1200,
		xl: 1536
	}, unit = "px", step = 5 } = breakpoints, other = _objectWithoutPropertiesLoose(breakpoints, _excluded$7);
...
var _excluded$7, sortBreakpointsValues;
...
function createTheme$1(options = {}, ...args) {
	const { breakpoints: breakpointsInput = {}, palette: paletteInput = {}, spacing: spacingInput, shape: shapeInput = {} } = options, other = _objectWithoutPropertiesLoose(options, _excluded$6);
...
function extendSxProp(props) {
	const { sx: inSx } = props;
	const { systemProps, otherProps } = splitProps(_objectWithoutPropertiesLoose(props, _excluded$5));
	let finalSx;
...
function createPalette(palette) {
	const { mode = "light", contrastThreshold = 3, tonalOffset = .2 } = palette, other = _objectWithoutPropertiesLoose(palette, _excluded$4);
...
function createTypography(palette, typography) {
	const _ref = typeof typography === "function" ? typography(palette) : typography, { fontFamily = defaultFontFamily, fontSize = 14, fontWeightLight = 300, fontWeightRegular = 400, fontWeightMedium = 500, fontWeightBold = 700, htmlFontSize = 16, allVariants, pxToRem: pxToRem2 } = _ref, other = _objectWithoutPropertiesLoose(_ref, _excluded$3);
...
function createTransitions(inputTransitions) {
	...
	const create = (props = ["all"], options = {}) => {
		const { duration: durationOption = mergedDuration.standard, easing: easingOption = mergedEasing.easeInOut, delay = 0 } = options, other = _objectWithoutPropertiesLoose(options, _excluded$2);
		{
...
function createTheme(options = {}, ...args) {
	const { mixins: mixinsInput = {}, palette: paletteInput = {}, transitions: transitionsInput = {}, typography: typographyInput = {} } = options, other = _objectWithoutPropertiesLoose(options, _excluded$1);
...
//#endregion
export { createBreakpoints as $, init_styleFunctionSx as A, createSpacing as B, init_getDisplayName as C, lightBlue as Ct, generateUtilityClass as D, common as Dt, generateUtilityClasses as E, red as Et, defaultSxConfig as F, getPath as G, createUnarySpacing as H, init_sizing as I, capitalize as J, init_style as K, init_palette as L, init_createTheme as M, createTheme$1 as N, clsx as O, styleFunctionSx as P, resolveBreakpointValues as Q, init_cssGrid as R, resolveProps as S, green as St, require_react_is as T, purple as Tt, getValue as U, init_createSpacing as V, init_spacing as W, init_breakpoints as X, handleBreakpoints as Y, mergeBreakpointsInOrder as Z, createMixins as _, _extends as _t, useDefaultProps as a, internal_processStyles as at, init_clamp as b, grey as bt, rootShouldForwardProp as c, styled_engine_exports as ct, createMuiTheme as d, require_prop_types as dt, init_createBreakpoints as et, createTheme as f, css as ft, require_colorManipulator as g, init_objectWithoutPropertiesLoose as gt, createTypography as h, _objectWithoutPropertiesLoose as ht, svgIconClasses as i, init_styled_engine as it, extendSxProp as j, ClassNameGenerator as k, slotShouldForwardProp as l, GlobalStyles as lt, easing as m, ThemeContext as mt, SvgIcon as n, deepmerge as nt, capitalize_default as o, internal_serializeStyles as ot, duration as p, keyframes as pt, init_capitalize as q, getSvgIconUtilityClass as r, isPlainObject as rt, styled as s, styled$1 as st, createSvgIcon as t, init_deepmerge as tt, defaultTheme as u, StyledEngineProvider as ut, DefaultPropsProvider$1 as v, init_extends as vt, getDisplayName as w, blue as wt, clamp as x, orange as xt, composeClasses as y, identifier_default as yt, init_borders as z };

//# sourceMappingURL=createSvgIcon-D_OhskZN.js.map